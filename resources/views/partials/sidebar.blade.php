            ...
            <li class="nav-item">
                ...
                <div id="collapseExpense" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item {{ request()->is('admin/incomes') || request()->is('admin/incomes/*') ? 'active' : '' }}" href="{{ route('admin.incomes.index') }}"> <i class="fa fa-briefcase mr-2"></i> {{ __('Income') }}</a>                    </div>
                </div>
            </li>
